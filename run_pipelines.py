...
def run_data_ingestion_pipeline():
    ...
    data_ingestion_pipeline = DataIngestionPipeline(
        config=data_ingestion_config, artifact=data_ingestion_artifact
    )
...
def run_feature_engineering_pipeline():
    ...
    feature_engineering_pipeline_config = FeatureEngineeringPipelineConfig(
        feature_engineering_dir=base_artifact_dir
    )
    ...
    feature_engineering_pipeline = FeatureEngineeringPipeline(
        ...
        artifact=feature_engineering_artifact,
...
def run_training_model_pipeline():
    ...
    model_training_pipeline_config = ModelTrainingPipelineConfig(
        model_training_dir=base_artifact_dir
    )
    # Create the FeatureEngineeringPipelineConfig
    feature_engineering_pipeline_config = FeatureEngineeringPipelineConfig(
        feature_engineering_dir=base_artifact_dir
    ...
    model_training_pipeline = ModelTrainingPipeline(
        model_training_config, model_training_artifact, feature_engineering_config
    )
